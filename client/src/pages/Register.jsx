  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-base-100">
      <div className="w-full max-w-md bg-base-100 border-4 border-black p-8 relative shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
        ...
        {success && (
          <div className="bg-green-100 border-4 border-green-500 text-green-700 px-4 py-3 mb-4 relative">
            <span className="font-bold uppercase text-sm">Account created!</span>
            <div className="absolute bottom-1 right-1 w-0 h-0 border-l-[8px] border-l-transparent border-b-[8px] border-b-green-500"></div>
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="form-control">
            <label className="label">
              <span className="label-text font-bold uppercase text-xs tracking-tight">Username</span>
            </label>
            <input
              type="text"
          ...
          <div className="form-control">
            <label className="label">
              <span className="label-text font-bold uppercase text-xs tracking-tight">Email</span>
            </label>
            <input
              type="email"
          ...
          <div className="form-control">
            ...
            <label className="label">
              <span className="label-text-alt text-xs">Must be at least 6 characters</span>
            </label>
          </div>
        ...
        <p className="text-center text-sm mt-6">
          ...
          <Link to="/login" className="font-bold uppercase text-xs tracking-tight underline hover:no-underline">
            Log in here
          </Link>
        </p>
